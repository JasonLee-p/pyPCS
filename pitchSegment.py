...
class PitchSegment:
    ...
    def __init__(self, segment: List[List[int], List[str]], __style=None):
        ...
        self.total_duration = np.sum([float(eval(d)) for d in self.duration_set])  # 获取总时值
    ...
    def __sub__(self, sub_pitch: int):
        ...
        return PitchSegment([new_pitch_set, self.duration_set][:]), self, f"Transposition{12 - sub_pitch}"
    ...
    def __setitem__(self, key, value):
        ...
        return PitchSegment(
            [new_pitch_set, self.duration_set[:]]), self, f"Reset pitch[{key}]{note_value[value]}"
    ...
    def new_segment(self, note_num: int, total_duration: float, first_note: int, note_scale: float, style: str):
    ...
    def get_counterpoint(self) -> Tuple[PitchSegment, PitchSegment, str]:
    ...
    def Transposition(self, add_pitch: int) -> Tuple[PitchSegment, PitchSegment, str]:
        """
    ...
    def Retrograde_with_rhyme(self, add_pitch: int = 0) -> Tuple[PitchSegment, PitchSegment, str]:
        """
        ...
        return PitchSegment([new_pitch_set, self.duration_set[:]]), self, f"Retrograde{add_pitch}"

    def Retrograde_without_rhyme(self, add_pitch: int = 0) -> Tuple[PitchSegment, PitchSegment, str]:
        """
    ...
    def Inversion(self, axes: int) -> Tuple[PitchSegment, PitchSegment, str]:
        """
        ...
        return PitchSegment([new_pitch_set, self.duration_set[:]]), self, f"Inversion{axes}"

    def RetrogradeInversion(self, axes: int) -> Tuple[PitchSegment, PitchSegment, str]:
        """
        ...
        new_duration_set = reversed(self.duration_set)
        return PitchSegment([new_pitch_set, new_duration_set]), self, f"RetrogradeInversion{axes} (with rhyme)"

    def Rotation_without_rhyme(self, num: int, add_pitch: int = 0) -> Tuple[PitchSegment, PitchSegment, str]:
        """
    ...
    def Rotation_with_rhyme(self, num: int, add_pitch: int = 0) -> Tuple[PitchSegment, PitchSegment, str]:
        """
